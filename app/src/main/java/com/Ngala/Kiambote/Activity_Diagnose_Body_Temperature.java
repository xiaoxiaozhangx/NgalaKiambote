...
public class Activity_Diagnose_Body_Temperature extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diagnose_body_temperature);
    ...
    private void checkSensor() {
        if (mSensorManager != null) {
            ...
            Toast.makeText(Activity_Diagnose_Body_Temperature.this, "not sensor", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        mTextQuantityTemperature.setText(String.valueOf(sensorEvent));
    }
